...
## Project Overview
The Hospital Management System (HMS) is a web-based platform designed to streamline hospital operations. It centralizes patient management, HR, logistics, financials, and administrative tasks into one unified interface.

---

## Hospital Management Project Team

| Subsystem / Team | Role / Position | Name |
|-----------------|----------------|------|
...
|-----------------|-------------|
| Core1 & Core2   | Clinical and patient care management |
| HR1, HR2, HR3, HR4 | HR management: employee records, payroll, attendance, recruitment, leave |
| Logistics1 & Logistics2 | Inventory and supply chain management |
| Financials      | Billing, accounting, financial reporting |

                    ...
                    <div class="card-body">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td>{{ $applicant->specialization ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <th>Status</th>
                                <td>
                                    <span
                                        class="badge {{ $applicant->application_status == 'rejected' ? 'bg-danger' : 'bg-success' }}">
                            ...
                            <div class="mb-3">
                                ...
                                @if(!$isInterviewFinished && $applicant->schedule_date)
                                    <div class="form-text text-danger mt-2">
                                        <small><i class="fas fa-lock"></i> "Accepted" status is locked until the interview
                                            date/time has passed.</small>
                                    </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body text-center">
                        @if($applicant->resume_path)
                            <a href="{{ route('hr1.applicants.download', $applicant->id) }}"

...
<head>
    ...
    <style>
        ...
        .core2-sidebar-node { transition: all 0.2s; cursor: pointer; border-left: 4px solid transparent; }
        .core2-sidebar-node:hover { background-color: #f1f5f9; }
        .core2-sidebar-node.active { background-color: #eff6ff; color: #0a5ec4; border-left-color: #0a5ec4; }
        ...
        .core2-sub-node {
            ...
            font-size: 0.72rem; font-weight: 700; color: #64748b; margin: 2px 8px;
            transition: all 0.2s; text-transform: uppercase; text-decoration: none;
        }
        .core2-sub-node:hover { background-color: #f8fafc; color: #0a5ec4; }
        .core2-sub-node.active { color: #4f46e5; background-color: #f5f3ff; font-weight: 800; }
        ...
        .core2-flash-success {
            animation: core2-fadeIn 0.3s ease-out;
        }
    </style>
    @stack('styles')
</head>
            ...
            <div>
                <button onclick="toggleMenu('menu-pharmacy')" class="core2-sidebar-node w-full p-4 rounded-2xl flex items-center justify-between {{ $pharmacyActive ? 'active' : '' }}">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="font-bold text-xs uppercase">Pharmacy</span>
                    </div>
                    <svg class="w-3 h-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg>
                </button>
            ...
            <div>
                <button onclick="toggleMenu('menu-packages')" class="core2-sidebar-node w-full p-4 rounded-2xl flex items-center justify-between {{ $pkgActive ? 'active' : '' }}">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="font-bold text-xs uppercase">Medical Packages</span>
                    </div>
                    <svg class="w-3 h-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg>
                </button>
            ...
            <div>
                <button onclick="toggleMenu('menu-laboratory')" class="core2-sidebar-node w-full p-4 rounded-2xl flex items-center justify-between {{ $labActive ? 'active' : '' }}">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="font-bold text-xs uppercase">Laboratory</span>
                    </div>
                    <svg class="w-3 h-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg>
                </button>
            ...
            <div>
                <button onclick="toggleMenu('menu-surgery')" class="core2-sidebar-node w-full p-4 rounded-2xl flex items-center justify-between {{ $surgActive ? 'active' : '' }}">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="font-bold text-xs uppercase">Surgery & Diet</span>
                    </div>
                    <svg class="w-3 h-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg>
                </button>
            ...
            <div>
                <button onclick="toggleMenu('menu-bed')" class="core2-sidebar-node w-full p-4 rounded-2xl flex items-center justify-between {{ $bedActive ? 'active' : '' }}">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="font-bold text-xs uppercase">Bed & Linen</span>
                    </div>
                    <svg class="w-3 h-3 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg>
                </button>
        ...
        <div class="p-5 bg-slate-50 border-t border-slate-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-xs">

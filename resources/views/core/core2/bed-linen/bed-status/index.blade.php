        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                    <td class="px-8 py-5 text-xs font-black text-slate-900">{{ $r->bed_id }}</td>
                    ...
                    <td class="px-8 py-5 text-xs font-semibold text-slate-500">{{ $r->patient_id ?? '—' }}</td>
                </tr>
                @empty
                <tr><td colspan="4" class="py-20 text-center text-slate-300 font-bold italic">No bed status records found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>

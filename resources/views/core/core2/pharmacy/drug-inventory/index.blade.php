...
<div class="flex justify-between items-start mb-8">
    ...
    <div class="flex gap-3">
        <a href="{{ route('core2.pharmacy.drug-inventory.requestform') }}" class="bg-white text-slate-700 border border-slate-200 px-7 py-4 rounded-2xl font-black text-xs uppercase flex items-center gap-3 shadow-sm hover:bg-slate-50 transition">
